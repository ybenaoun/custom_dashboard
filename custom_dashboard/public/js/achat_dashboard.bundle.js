...
class AchatDashboardApp {
	constructor({
		...
		moduleLabel = "Achats",
		pageTitle = "",
		workspaceHref = "/app/buying?cd_skip=1",
	}) {
		this.$wrapper = $(wrapper);
		this.page = page;
		this.moduleName = (moduleName || "Buying").trim() || "Buying";
		...
		this.workspaceHref = workspaceHref || "/app/buying?cd_skip=1";
...
custom_dashboard.ui.AchatDashboardApp = AchatDashboardApp;

export default AchatDashboardApp;
