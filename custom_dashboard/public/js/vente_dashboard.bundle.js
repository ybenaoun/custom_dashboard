...
class VenteDashboardApp {
	constructor({
		...
		moduleLabel = "Ventes",
		pageTitle = "",
		workspaceHref = "/app/selling?cd_skip=1",
	}) {
		this.$wrapper = $(wrapper);
		this.page = page;
		this.moduleName = (moduleName || "Selling").trim() || "Selling";
		...
		this.workspaceHref = workspaceHref || "/app/selling?cd_skip=1";
...
custom_dashboard.ui.VenteDashboardApp = VenteDashboardApp;

export default VenteDashboardApp;
